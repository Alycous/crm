...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //单选
            $("#searchActBody").on("click", "input[name=dx]", function () {
            ...
            $("#bundBtn").click(function () {
                ...
                if ($dx.length == 0) {
                    ...
                    //关联 workbench/clue/bund.do?cId=sss&aId=www&aId=ggg
                    var param = "cId=${c.id}&";
        ...
        function flush(){
            $.ajax({
                ...
                data: {"name": $.trim($("#aname").val()), "clueId": "${c.id}"},
                dataType: "json",
                type: "get",
                success: function (data) {
                    //data [{市场活动},{},{},{}]
        ...
        function unband(id) {
            //解除关联 删除关系表中的数据
            //id 需要是 tbl_clue_activity_relation 中的id 方便删除操作
            $.ajax({
        ...
        function showActivityList() {
            $.ajax({
                url: "workbench/clue/getActivitysByClueId.do",
                data: {"id": "${c.id}"},
                dataType: "json",
                type: "get",
                success: function (data) {
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?id=${c.id}&fullname=${c.fullname}&company=${c.company}&owner=${c.owner}';"><span
...
<div>
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a href="javascript:void(0);" data-toggle="modal" onclick="flush()" data-target="#bundModal"
