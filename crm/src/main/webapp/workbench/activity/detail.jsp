...
<%
    String basePath = request.getScheme() + "://" +
            ...
            request.getContextPath() + "/";  // http :// localhost : 3306   /crm  /
%>
<!DOCTYPE html>
<html>
<head>
        ...
        $(function () {
            ...
            $("#saveRemarkBtn").click(function () {
                ...
                $.ajax({
                    ...
                    data:{"activityId":"${a.id}","noteContent":$.trim($("#remark").val())},
                    dataType:"json",
                    type:"post",
                    success:function (data) {
                        ...
                        if (data.success){
                            //添加成功，在textare上方生成备注
                            //data {success:true,ar:{id,noteContent, createTime, createBy, editTime, editBy, editFlag, activityId}}
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                        html += '<a class="myHref" href="javascript:void(0);" onclick="updateRemark(\'' + n.id + '\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: red;"></span></a>';
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;';
    ...
    <div class="modal-dialog" role="document" style="width: 85%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myActivity">修改市场活动</h4>
            </div>
            <div class="modal-body">
...
<div style="position: relative; top: 30px; left: 40px;" id="remarkBody">
    <div class="page-header" id="upDiv">
        <h4>备注</h4>
    </div>
